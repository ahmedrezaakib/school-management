          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header row">
                <h3 class="card-title col-md-10">Fee List</h3>
                <a href="{{ route('fee-head.create') }}" class="col-md-2 nav-link btn btn-primary">
                  Add Fee Name
                </a>
              </div>
                  ...
                  <tbody>
                    @foreach ($fee as $item)
                      <tr>
                        ...
                        <td><a href="{{ route('fee-head.delete', $item->id) }}" onclick="return confirm('are you sure')"
