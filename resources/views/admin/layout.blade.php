...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        <div class="preloader flex-column justify-content-center align-items-center">
            <h2 style="font-weight:700;color:#2563eb;letter-spacing:1px;">
                School Management
            </h2>
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('admin.dashboard') }}" class="brand-link">
                <img src="{{ asset('assets/images/school-logo.png') }}" alt="School Management Logo"
                    class="brand-image rounded" style="opacity: .9; background:#fff;">
                <span class="brand-text font-weight-bold text-light">Admin Pannel</span>
            </a>
