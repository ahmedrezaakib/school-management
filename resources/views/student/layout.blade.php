                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <div class="dropdown-item text-center">
                            <img src="dist/img/user2-160x160.jpg" alt="User Avatar" class="img-circle elevation-2"
                                width="60">
                            <p class="mb-0 mt-2"><strong>{{ Auth::user()->name ?? 'Student' }}</strong></p>
                        ...
                        <form action="{{ route('student.logout') }}" method="POST" class="d-inline">
                            @csrf
                            <button type="submit" class="dropdown-item btn btn-link text-danger p-0">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="https://png.pngtree.com/png-vector/20220727/ourmid/pngtree-illustration-of-smiling-boy-face-png-image_6080118.png"
                            class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">{{ Auth::user()->name ?? 'Student' }}</a>
                        <small class="text-light">Grade: {{ Auth::user()->class->name ?? 'N/A' }}</small>
                    </div>
